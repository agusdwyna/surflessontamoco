...
const Footer = () => {
  const waveIcon = (
    <svg className="w-6 h-6 text-[#005a8d]" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-[#0f1c23] text-white/60 py-12 px-4 text-center">
      <div className="flex items-center justify-center gap-2 mb-6">
        {waveIcon}
        <span className="text-white font-bold text-xl tracking-tight">Surf Lesson Tamoco Bali</span>
      </div>
      <p className="text-sm mb-6">Jl. Sarinande, Seminyak, Kec. Kuta, Kabupaten Badung, Bali</p>
      ...
      <p className="text-xs">© 2026 Bali Surf School. Surf Lesson Tamoco Bali</p>
    </footer>
  );
};
